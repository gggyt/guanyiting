...
class AllUserComment extends React.Component {
  state = {
    disabled: false,
  }
  constructor(props) {
  ...
  getInvitation() {
     fetch(MyComment,{
        ...
        body: 'pageNum='+this.state.nowPage+'&pageSize='+this.state.pageSize+'&getMy='+this.props.match.params.id
