...
class MyUserDetail extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      userId: 4,
  ...
  updateUserInfo(){
    fetch(UpdateUserInfo,{   //Fetch方法
      ...
      body: 'userId=-1'+'&username='+this.state.username+'&realname='+this.state.realname+'&password='+this.state.password+
  ...
  render() {
    ...
    <div style={{backgroundColor:'#ffffff', padding:10}}>
          ...
          <div className="form-inline form" role="form" style={{marginTop:10}}> 
          ...
          <div className="form-inline form" role="form"> 
            ...
            <Input value={this.state.mobile} className="form-control" placeholder="手机号" onChange={this.mobileChange} style={{height:30 , width:200}}  disabled={true}/>
            </div> 
          </div>
          <div className="form-inline form" role="form"> 
            <div className="form-group"> 
            <label className="form-label">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</label> 
            <Input value={this.state.studentId} className="form-control" placeholder="学号" onChange={this.studentIdChange} style={{height:30 , width:200}}  disabled={true}/>
            </div> 
          </div>
          <div className="form-inline form" role="form"> 
            <div className="form-group"> 
